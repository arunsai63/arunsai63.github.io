...
let scrollFactor = 5 / scrollMax // Calculate how much to move per scroll pixel
...
function animate() {
    ...
    const scrollProgress = Math.min(currentScroll / scrollMax, 1)

    // Move code block based on scroll
    // From right to left
...
function onWindowResize() {
    ...
    // Recalculate scrollMax on resize
    scrollMax = document.body.scrollHeight - window.innerHeight
    scrollFactor = 5 / scrollMax
}
