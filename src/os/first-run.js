      ...
      content: (el) => {
        el.innerHTML = `
          <div style="text-align:center;padding:8px;">
            ...
            <h2 style="color:#fff;font-size:18px;margin-bottom:4px;">Welcome to ArunOS v6.5.0</h2>
            <p style="color:#666;font-size:13px;margin-bottom:20px;">The only portfolio that's also an operating system.</p>

            <div style="text-align:left;background:#12122a;padding:16px;border-radius:8px;margin-bottom:16px;">
              <p style="color:#aaa;font-size:13px;margin-bottom:12px;">What brings you here today?</p>
              <div style="display:flex;flex-direction:column;gap:8px;" id="wizard-options">
                <label style="display:flex;align-items:center;gap:10px;padding:8px 12px;background:#1a1a30;border:1px solid #2a2a3e;border-radius:6px;cursor:pointer;transition:all 0.15s;color:#ccc;font-size:13px;">
        ...
        el.querySelectorAll('label').forEach(label => {
          label.addEventListener('click', () => {
            el.querySelectorAll('label').forEach(l => l.style.borderColor = '#2a2a3e')
        ...
        el.querySelector('#wizard-continue').addEventListener('click', () => {
          ...
          const responses = {
            hiring: { title: '💼 Welcome, Recruiter!', body: "Resume icon added to desktop. I promise my code is better than my interview skills." },
