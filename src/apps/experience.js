    ...
    content: (el) => {
      ...
      el.innerHTML = `
        <div style="font-family:'JetBrains Mono',monospace;font-size:12px;">
          ...
          <div style="padding:12px 16px;background:#0d0d1a;border-bottom:1px solid #222;">
            <div style="display:flex;gap:24px;margin-bottom:8px;">
              <div>
                ...
                <div style="height:4px;background:#1a1a30;border-radius:2px;margin-top:4px;width:200px;overflow:hidden;">
          ...
          <div style="display:grid;grid-template-columns:40px 1fr 180px 100px 70px 70px 120px;padding:8px 16px;background:#111128;color:#666;font-size:11px;border-bottom:1px solid #1a1a30;position:sticky;top:0;">
            <span>PID</span>
            <span>PROCESS</span>
            <span>COMPANY</span>
            <span>DATES</span>
        ...
        row.addEventListener('click', () => {
          ...
          detail.innerHTML = `
            ...
            <div style="display:flex;flex-wrap:wrap;gap:6px;">
              ${exp.tech.map(t => `<span style="padding:2px 8px;background:#1a1a30;border:1px solid #2a2a3e;border-radius:4px;font-size:11px;color:#888;">${t}</span>`).join('')}
            </div>
