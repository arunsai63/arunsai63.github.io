                ...
                <div className={`rounded-lg shadow-lg overflow-hidden ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
                    ...
                    <div className="flex flex-col md:flex-row relative">
                        ...
                        <div className={`w-full md:w-2/3 lg:w-3/4 p-4 ${isDark ? 'bg-gray-800' : 'bg-white'}`}>
                            <div className="mt-2">
                                <h2 className={`${isDark ? 'text-green-400' : 'text-green-500'} uppercase font-bold text-lg mb-3`}>Experience</h2>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className={`border-l-4 ${isDark ? 'border-green-400' : 'border-green-500'} px-3`}>
                                        <div className='py-1'>
                                            <div className="flex flex-col sm:flex-row sm:justify-between">
