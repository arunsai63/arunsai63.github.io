                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="mt-2 text-sm">
                                        <div className="flex items-center mt-1">
                                            ...
                                            <a href="https://www.linkedin.com/in/arun-munaganti/"
                                                target="_blank"
                                                rel="noreferrer"
                                                className="hover:text-green-500 transition-colors truncate">
                                                linkedin.com/in/arun-munaganti
                                            </a>
                                        </div>
                                        <div className="flex items-center mt-1">
                                            <FaLinkedin className="text-green-500 mr-2 flex-shrink-0" />
                                ...
                                <div className="space-y-4">
                                    <div className="border-l-4 border-green-500 pl-3">
                                        <div className="flex flex-col sm:flex-row sm:justify-between">
                                            ...
                                            <span className="text-sm text-gray-600">Hyderabad, India 09/2024 - Present</span>
                                        </div>
                                    ...
                                    <div className="border-l-4 border-green-500 pl-3">
                                        <div className="flex flex-col sm:flex-row sm:justify-between">
                                            ...
                                            <span className="text-sm text-gray-600">Hyderabad, India 01/2023 - 09/2024</span>
                                        </div>
                                        <ul className="list-disc list-inside mt-1 text-sm">
                                    ...
                                    <div className="border-l-4 border-green-500 pl-3">
                                        <div className="flex flex-col sm:flex-row sm:justify-between">
                                            ...
                                            <span className="text-sm text-gray-600">Hyderabad, India 12/2021 - 01/2023</span>
                                        </div>
                                        <ul className="list-disc list-inside mt-1 text-sm">
                                    ...
                                    <div className="border-l-4 border-green-500 pl-3">
                                        <div className="flex flex-col sm:flex-row sm:justify-between">
                                            ...
                                            <span className="text-sm text-gray-600">Mumbai, India 04/2021 - 12/2021</span>
                                        </div>
                                        <ul className="list-disc list-inside mt-1 text-sm">
                                    ...
                                    <div className="border-l-4 border-green-500 pl-3">
                                        <div className="flex flex-col sm:flex-row sm:justify-between">
                                            ...
                                            <span className="text-sm text-gray-600">Hyderabad, India 08/2020 - 04/2021</span>
                                        </div>
                                        <ul className="list-disc list-inside mt-1 text-sm">
                                    ...
                                    <div className="border-l-4 border-green-500 pl-3">
                                        <div className="flex flex-col sm:flex-row sm:justify-between">
                                            ...
                                            <span className="text-sm text-gray-600">Hyderabad, India 01/2019 - 08/2020</span>
                                        </div>
                                        <ul className="list-disc list-inside mt-1 text-sm">
