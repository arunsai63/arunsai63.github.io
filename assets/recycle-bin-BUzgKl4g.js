import{c as s}from"./index-BwLrzomA.js";const i=[{name:"jquery-spaghetti-2019.js",size:"847 KB",date:"2019-06-14",desc:"My first production code. No one should see this."},{name:"my-first-blockchain.sol",size:"2.1 KB",date:"2020-03-22",desc:"DO NOT DEPLOY. I repeat, DO NOT DEPLOY."},{name:"node_modules/",size:"∞",date:"every single day",desc:"It keeps coming back. Like a horror movie villain."},{name:"todo-app-tutorial/",size:"156 KB",date:"2019-01-15",desc:"The required rite of passage. Completed. Never looked at again."},{name:"fix-bug-attempt-1.patch",size:"3 KB",date:"2021-08-03",desc:"Spoiler: it did not fix the bug."},{name:"fix-bug-attempt-2.patch",size:"3 KB",date:"2021-08-03",desc:"Spoiler: neither did this one."},{name:"fix-bug-attempt-FINAL.patch",size:"12 KB",date:"2021-08-04",desc:"This one worked. By mass-deleting the feature."},{name:"credentials.env",size:"1 KB",date:"2020-01-02",desc:"Committed to git once. Once was enough."}];function a(){s({id:"recycle-bin",title:"Recycle Bin — My Past Mistakes",icon:"🗑️",width:550,height:400,content:t=>{t.style.cssText='padding:0;font-family:"JetBrains Mono",monospace;font-size:12px;',t.innerHTML=`
