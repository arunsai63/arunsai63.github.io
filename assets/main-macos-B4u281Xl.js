const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/os-switcher-BISuGRlW.js","assets/index-Dui7f6k8.js","assets/index-BfiTSkJx.css","assets/registry-qmn67aww.js","assets/console-easter-egg-DB4rPIQL.js"])))=>i.map(i=>d[i]);
import{_ as H}from"./index-Dui7f6k8.js";import{c as Q,g as ae,t as re,a as le,b as ce}from"./window-manager-Cm3UCJuh.js";import{openApp as C,appList as ee}from"./registry-qmn67aww.js";import{b as c,r as D,o as de,c as pe,s as ue,i as ye,a as ge}from"./console-easter-egg-DB4rPIQL.js";import{g as N,a as fe,p as q}from"./data-CMMTyLTn.js";let k=null;function me(){return k||(k=document.createElement("div"),k.className="notification-container",document.body.appendChild(k),k)}function x(t,e,n=4e3,o=null){const i=me(),s=document.createElement("div");s.className="notification-toast";const a=o?`<span class="notification-icon">${c(o,18,"#10b981")}</span>`:"";s.innerHTML=`
...
(yes, he's probably coding right now)`}function Me(t){P?$():Le(t)}function Le(t){$(),P=!0;const e=document.createElement("div");e.className="start-menu open",e.id="start-menu";const n=ee();e.innerHTML=`
  ...
  `,t.appendChild(e)}function R(t){const e=document.createElement("div");return e.className=`widget ${t}`,e}function z(t){return t.toString().padStart(2,"0")}async function st(t){await Ae(t);const e=ve(t);Ue(e),Se(e);const n=e.querySelector(".desktop-area");n&&Ke(n),ye().then(o=>{o&&(ze(o.db,o.userId),x("Connected","Multiplayer enabled. Other visitors can see your cursor.",4e3,"wifi"))}).catch(()=>{}),H(async()=>{const{openApp:o}=await import("./registry-qmn67aww.js");return{openApp:o}},__vite__mapDeps([3,1,2,4])).then(({openApp:o})=>o("about")),Fe(),te(),_e(),ge(),De(),document.addEventListener("keydown",o=>{(o.ctrlKey||o.metaKey)&&o.key==="t"&&(o.preventDefault(),H(async()=>{const{openApp:i}=await import("./registry-qmn67aww.js");return{openApp:i}},__vite__mapDeps([3,1,2,4])).then(({openApp:i})=>i("terminal")))})}export{st as boot};
