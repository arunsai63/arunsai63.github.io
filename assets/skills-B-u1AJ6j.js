import{c as p}from"./window-manager-Cm3UCJuh.js";import{s as l}from"./data-CMMTyLTn.js";function c(e){e.style.cssText='padding:0;display:flex;flex-direction:column;font-family:"JetBrains Mono",monospace;',e.innerHTML=`
      ...
      `;let i=!1;const t=e.querySelector("#skills-content"),s=e.querySelector("#skills-view-toggle");r(t),s.addEventListener("click",()=>{i=!i,s.textContent=i?"View: 📊 Visual → 📝 Text":"View: 📝 Text → 📊 Visual",i?d(t):r(t)})}function y(){p({id:"skills",title:"Skills.txt — Notepad",icon:"⚡",width:600,height:480,content:e=>c(e)})}function r(e){const i=Object.entries(l).map(([t,s])=>`<span style="color:#10b981;"># ${t.toUpperCase()}</span>
${s.map(o=>`  - ${o}`).join(`
`)}`).join(`
...
# Skills marked * are mass overrepresented in my imposter syndrome.</span></pre>`}function d(e){const i=Object.entries(l);e.innerHTML=`
      ...
      ${i.map(([t,s])=>`
        <div>
          ...
          <div style="display:flex;flex-wrap:wrap;gap:6px;">
            ${s.map(o=>{const n=x(o),a=n>85?"#10b981":n>70?"#3b82f6":n>55?"#f59e0b":"#8b5cf6";return`
