import{c as i,g as s}from"./index-BwLrzomA.js";const n=[{name:"Default",bg:"#1a1a2e",gradient:"radial-gradient(ellipse at 20% 50%, rgba(16, 185, 129, 0.05) 0%, transparent 50%), radial-gradient(ellipse at 80% 50%, rgba(59, 130, 246, 0.05) 0%, transparent 50%)"},{name:"Midnight",bg:"#0a0a1a",gradient:"radial-gradient(ellipse at 50% 50%, rgba(59, 130, 246, 0.08) 0%, transparent 60%)"},{name:"Forest",bg:"#0a1a0a",gradient:"radial-gradient(ellipse at 30% 70%, rgba(16, 185, 129, 0.1) 0%, transparent 50%)"},{name:"Sunset",bg:"#1a0a0a",gradient:"radial-gradient(ellipse at 50% 80%, rgba(239, 68, 68, 0.06) 0%, transparent 50%), radial-gradient(ellipse at 60% 20%, rgba(245, 158, 11, 0.05) 0%, transparent 40%)"},{name:"Void",bg:"#000000",gradient:"none"}];function l(){i({id:"settings",title:"Settings",icon:"⚙️",width:480,height:380,content:t=>{t.innerHTML=`
        <h3 style="color:#fff;font-size:15px;margin-bottom:16px;">🎨 Wallpaper</h3>
        <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:20px;">
          ${n.map((e,a)=>`
            <div class="wp-option" data-idx="${a}" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid #262626;transition:border-color 0.2s;">
      ...
      `,t.querySelectorAll(".wp-option").forEach(e=>{e.addEventListener("click",()=>{const a=n[parseInt(e.dataset.idx)],r=document.querySelector(".desktop");r&&(r.style.background=a.bg,r.style.backgroundImage=a.gradient),t.querySelectorAll(".wp-option").forEach(o=>o.style.borderColor="#262626"),e.style.borderColor="#10b981"})})}})}export{l as open};
