import{c,f as y}from"./index-CeLzqF6v.js";function b(){c({id:"projects",title:"File Explorer — ~/projects",icon:"📁",width:600,height:420,content:o=>{o.style.cssText='padding:0;font-family:"JetBrains Mono",monospace;font-size:13px;display:flex;flex-direction:column;';let r="~";function t(i){r=i;const s=p(i);if(!s||s.type!=="dir")return;const f=i.split("/").map((e,n,d)=>`<span class="breadcrumb" data-path="${d.slice(0,n+1).join("/")}" style="cursor:pointer;color:#3b82f6;">${e}</span>`).join(' <span style="color:#555;">/</span> ');o.innerHTML=`
