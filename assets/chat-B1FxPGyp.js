import{c as C}from"./window-manager-Cm3UCJuh.js";import{q as S,l as E,r as x,g as k,o as z,d as T,p as w}from"./console-easter-egg-Ch-v8MMI.js";const f=["#10b981","#3b82f6","#f59e0b","#ef4444","#8b5cf6","#ec4899"];function M(e){const n=f[Math.floor(Math.random()*f.length)],o=localStorage.getItem("arunos-chat-name")||"Anonymous Visitor";e.style.cssText="padding:0;display:flex;flex-direction:column;font-size:13px;",e.innerHTML=`
